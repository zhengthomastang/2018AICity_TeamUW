...
extern void run_lp_det(char *datacfg, char *cfgfile, char *weightfile, char *intxtname, char *outtxtname, float thresh, float hier_thresh);
...
int main(int argc, char **argv)
{
    ...
    } else if (0 == strcmp(argv[1], "runlpdet")){
        run_lp_det(argv[2], argv[3], argv[4], argv[5], argv[6], atof(argv[7]), atof(argv[8]));
    } else {
